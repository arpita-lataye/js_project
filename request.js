...
axios.get('https://api.merakilearn.org/courses')
    .then(resp=>{
        ...
        fs.writeFileSync("request_course.json",m) 
        ...
        .then(response=>{
            ...
            fs.writeFileSync("request_course_exercise.json",p)
            ...
            fs.writeFileSync("request_parent_exercise.json",list1_data)
            list2_data=JSON.stringify(child_exe,null,4)
            fs.writeFileSync("request_child_exercise.json",list2_data)
