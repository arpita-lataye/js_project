...
const fs=require('fs')
var file=fs.existsSync("passData.json")
...
if (file==false){
    ...
    fs.writeFileSync("passData.json",JSON.stringify(mylist,null,4))
    ...
    if (login_signup=="1"){
        ...
        data1=fs.readFileSync("passData.json","utf8")
