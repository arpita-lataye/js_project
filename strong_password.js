...
registration=string.question("what you choose (1)signup  or (2)login (give number): ")
const fs=require('fs')
var file=fs.existsSync("myData.json")
...
if (file==false){
    ...
    fs.writeFileSync("myData.json",JSON.stringify(mylist,null,4))
    ...
    if (registration=="1"){
        ...
        data1=fs.readFileSync("myData.json","utf8")
